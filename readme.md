...
| **Distinct samples (any layer)** | n/a | **42** | **16,938** | n/a |
...
Full instance: **11.4 GB**, of which 2.4 GB backbone and 9.0 GB quantitative
...
- **PheKnowLator** instance-based OWLNETS build → [Zenodo 10689968](https://zenodo.org/records/10689968), to be placed under `data/pkt/builds/v3.0.2/`
