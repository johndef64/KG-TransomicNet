...
pkf_df = pd.read_csv(pkt_file)
# Nota: La riga di campionamento è commentata, se i dati sono grandi potresti volerla decommentare
# pkf_df.sample(10000).to_csv(r'..\temp_dir\sample_10000.csv', index=False)
# pkf_df = pd.read_csv(r'..\temp_dir\sample_10000.csv')
...
nodes, edges = convert_rdf_to_property_graph(pkf_df)
