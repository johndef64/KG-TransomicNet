...
#%% --------------------------------------------------------------------------
from omics_utils import read_data_type, PROBEMAP_PATHS
...
for chrom in chromosomes:
    ...
    gene_mappings.to_csv(f"../data/mappings/temp/biomart_gene_mappings_chr{chrom}.tsv", sep='\t', index=False)
...
master_gene_mappings.to_csv("../data/mappings/biomart_gene_mappings.tsv", sep='\t', index=False)
#%%
